-- Database Schema for Fertiliser Retail Management System
...
WHERE NAME IN('Urea','DAP','NPK','Potash','Organic');

-- Products Table (Fertilisers)
...
VALUES ('Fertiliser Retail System', '123 Agriculture Road, Farm City', '+1234567890', 'info@fertiliserretail.com');

UPDATE company_info
SET company_name = 'SRI KAMESWARI FERTILISERS',
    address = 'Near Shiva Temple,Narasannapeta',
    phone='9010858107',
    email='srikameswarifertiliser@gmail.com'
WHERE id = 1;

-- Businesses Table for Registrations
